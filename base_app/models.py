...
class Promissory(models.Model):
    ...
    inital_paid_on=models.DateField(  null=True, blank=True,default='')
    inital_paid_amount=models.CharField( max_length=1000,null=True, blank=True,default='')
    inital_paid_date=models.DateField(  null=True, blank=True,default='')
    inital_balance_amount=models.CharField(max_length=1000,null=True, blank=True,default='')
    inital_due_date=models.DateField(  null=True, blank=True,default='')
    ...
    second_due_on=models.DateField( null=True, blank=True,default='')
    second_paid_amount=models.CharField(max_length=1000,null=True, blank=True,default='')
    second_paid_date=models.DateField(  null=True, blank=True,default='')
    second_balance_amount=models.CharField(max_length=1000,null=True, blank=True,default='')
    second_due_date=models.DateField(null=True, blank=True,default='')
    ...
    final_due_on=models.DateField( null=True, blank=True,default='')
    final_paid_amount=models.CharField(max_length=1000,null=True, blank=True,default='')
    final_paid_date=models.DateField( null=True, blank=True,default='')
    final_balance_amount=models.CharField(max_length=1000,null=True, blank=True,default='')
    final_due_date=models.DateField(null=True, blank=True,default='')
